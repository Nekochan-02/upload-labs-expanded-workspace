...
* **Phase 2C-F17 / right-side resize collapse targeted canary**:
  * **Status: `F17_TOP_RIGHT_WIDTH_COLLAPSE_VERIFIED`**
  ...
  * `0.2.24` remains a local development canary only: `dist/Nekochan-ExpandedWorkspace-0.2.24.zip`, `22115` bytes, `15` files, ZIP root `mods-unpacked`, SHA-256 `942f67e0e0535b208a6ecc67d1d13cd9baf714035a8471dcdad55926373e7e7c`. The single next action is a fresh-session `right`-edge childless group canary; do not touch top-left or top-right first, do not save after failure, and provide `[F17]` logs. Group persistence, full regression, release integration, public push, Release/tag/Workshop operation, and v0.2.9 artifact operations remain deferred.
* **Phase 2A 検証状態**:
